...
const Navbar = () => {
  ...
  const isScrolled = useScrolledWindow(80);
  const isShowed = useScrolledWindow(120);
  ...
  return (
    <div className="absolute top-0 w-full">
      <nav
        ...
        } flex py-6 justify-between items-center navbar ${isScrolled && 'scrolled'} ${
          isShowed && 'active'
      ...
      >
        ...
        <div className="sm:hidden flex justify-end items-center">
          ...
          <div
            ...
            } p-6 bg-black-gradient absolute top-20 right-0 mx-4  rounded-xl sidebar`}
          >
